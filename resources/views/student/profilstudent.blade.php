@include('student.headerstudent')
@include('student.navbarstudent')
...
<body>
    ...
    <div class="title"> Etudiant Profile</div>
...
@include('student.scriptstudent')
@include('student.footerstudent')
